...
from yt_dlp import _real_main,YoutubeDL
if TYPE_CHECKING:
...
class YoutubeCrawler(Crawler):
    ...
    async def fetch(self, scrape_item: ScrapeItem) -> None:
        """Runs yt-dlp"""
        media_item,filename=await self.get_media_item_and_filename(scrape_item)
    ...
    async def get_media_item_and_filename(self, scrape_item: ScrapeItem)  :
