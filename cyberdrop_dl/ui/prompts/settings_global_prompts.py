...
""",
    ...
    keep_current = inquirer.select(
        ...
        long_instruction="Keep a curent file. Current files are files that were either downloaded or files that were skipped for already existing when dedupe_already_downloaded is true",
